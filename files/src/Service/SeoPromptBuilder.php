        ...
        return [
            ...
            'input_schema' => [
                ...
                'properties' => [
                    ...
                    'missing_data' => [
                        'type' => 'array',
                        'description' => 'Une ligne par manque reel : [bloquant] pour un probleme de veracite ou une generation inutilisable, [relecture] pour un doute sur l utilite ou la repetition du contenu, [amelioration] pour une precision facultative omise du texte. Ne pas exiger des statistiques techniques propres a chaque ville.',
                        'items' => ['type' => 'string'],
                    ],
                ],
            ],
    ...
    private function buildContext(SeoSeed $seed): array
    {
        ...
        return [
            ...
            'local_evidence_policy' => [
                ...
                'insufficient_evidence' => 'Si l utilite ou la differenciation de la page parait insuffisante, signaler [relecture] avec une raison precise et recommander review. Une statistique technique ou typologie de bati par ville n est pas obligatoire: si ce seul detail manque, l omettre du texte et le noter [amelioration]. Ne pas combler avec une liste de monuments. Service et zone doivent rester confirmes.',
            ],
            'seo_rules' => [
                'do_not_invent' => [
                    'certifications',
...
- Distingue chaque missing_data avec [bloquant], [relecture] ou [amelioration]. [bloquant] concerne un service non confirme, une zone non couverte, une information inventee encore presente ou une generation inutilisable. [relecture] concerne un doute sur la valeur propre de la page ou un contenu potentiellement generique/repetitif : explique ce doute, sans le presenter comme une faussete prouvee. Une precision facultative absente du texte (statistiques locales sur le placo, etat des toitures, parc de chauffage, type de bati, contraintes locales...) releve de [amelioration], meme si elle aurait enrichi la page. L absence de ce seul detail ne justifie pas noindex ou un blocage.
- Si aucune matiere utile ne permet reellement de distinguer cette page, ajoute "[relecture] Contenu potentiellement interchangeable" et recommande review. Ne classe pas une affirmation non prouvee utilisee dans la page comme simple amelioration ou relecture: retire-la du texte ou signale un blocage. Le prefixe ne doit jamais minimiser un probleme de veracite. Une liste de monuments ou une paraphrase ne suffit pas a distinguer les pages.
